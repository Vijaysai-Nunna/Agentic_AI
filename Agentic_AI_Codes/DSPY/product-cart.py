...
class ProductCartSummary (dspy.Predict):
    def __init__ (self):
...
predictor = ProductCartSummary()
response = predictor(product_name= "Wireless Mouse", cart_items = "Laptop,Headphone, Laptop Bag")
print (response)